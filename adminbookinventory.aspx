                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                   <img id="imgview" width="100" src="book_inventory/books.png" />
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox9" runat="server" TextMode="Number" placeholder="Book Cost (per unit)"></asp:TextBox>
                            ...
                            <div class="col-md-4">
                                <label>Pages</label>
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox10" runat="server" placeholder="Pages" TextMode="Number"></asp:TextBox>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox7" runat="server" TextMode="Number" placeholder="Current Stock" ReadOnly="true"></asp:TextBox>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="Issued Books" TextMode="Number" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <asp:Button ID="Button1" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete" OnClick="Button1_Click" />
                            </div>
                        </div>
