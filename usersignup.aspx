                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                  <label>Full Name</label>
                                    ...
                                    <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="full_name"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                     ...
                                     <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="contact_no" TextMode="Number"></asp:TextBox>
